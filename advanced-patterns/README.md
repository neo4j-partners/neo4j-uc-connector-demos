...
`LAKEHOUSE_SCHEMA` settings in the scope named by `DATABRICKS_SECRET_SCOPE`
(default `neo4j-uc-demos`). The advanced notebooks read their connection and
catalog configuration from that scope.
