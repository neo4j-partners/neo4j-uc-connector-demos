...
MAINTENANCE_SCHEMA = """`v$id` STRING, aircraftId STRING, systemId STRING,
...
df = spark.read.format("jdbc") \
    ...
    .load() \
    .select("aircraftId", "fault", "severity", "corrective_action", "reported_at")
...
- `neo4j_flight_airports`: columns: flight_number, aircraftId, airport_code, airport_name
