...
* https://github.com/neo4j-partners/neo4j-uc-integration/blob/main/docs/neo4j_uc_jdbc_guide.md[Neo4j Federated JDBC UC Connection Setup Guide] - Full configuration reference
